...
const cardProps: CardProps[] = [
  {
    title: "Vergin Mojito",
    description:
      "A Restrount Showcase website for a restrount called Vergin Mojito",
  ...
  },
  {
    title: "Leet Ninja",
    description:
      "A LeetCode like platform for developers to practice their coding skills",
  ...
  },
  {
    title: "Vibe It",
    description:
      "An Ai Powered Web App Builder for vibe coders to create their own web apps",
  ...
  return (
    <div>
      ...
      <div className="w-full h-full border-t mt-5 dark:shadow-neutral-950  shadow-inner">
        <div className="m-5 border inline-block px-1 text-lg dark:bg-neutral-800 bg-neutral-100 dark:text-white">
      ...
      <div className="w-full h-screen border-t mt-5 dark:shadow-neutral-950 shadow-inner">
        <div className="m-5 border inline-block px-1 text-lg dark:bg-neutral-800 bg-neutral-100 dark:text-white">
