  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible &&
          "bg-neutral-100/90 border-neutral-300  dark:bg-neutral-900/50 border dark:border-neutral-700",
        className
      )}
    >
      {children}
...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "inset-0 hidden flex-1 flex-row items-center space-x-2 justify-center text-sm font-medium text-zinc-600 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-1",
        className
      )}
    >
      {items.map((item, idx) => (
